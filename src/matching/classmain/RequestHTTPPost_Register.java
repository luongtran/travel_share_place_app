...
public class RequestHTTPPost_Register extends AsyncTask<String, Void, String>{
	...
	protected String doInBackground(String... params) {
		...
		String district_id=params[5];
		String sex_id=params[6];
		String user_name=params[7];
	    String response="";
		try{
	                ...
	                nameValuePairs.add(new BasicNameValuePair("district_id",district_id));
	                nameValuePairs.add(new BasicNameValuePair("sex_id",sex_id));
